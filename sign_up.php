...
<html>
	...
	<?php
		...
		if(isset($_SESSION['id']))
		{
			$header_array = ['sign_up.php' => 'Home', 'details.php' => 'Details', 'dashboard.php' => 'Change Permissions', 'sign_out.php' => 'Sign out'];
		...
		<div class="row">
			...
			<form action="submit.php" method="post" id="sign_up_form" enctype=multipart/form-data>
					...
					<div class="well">
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="text" maxlength="10" name="first_name" id="first_name" class="form-control text_field" placeholder="First Name" 
								<?php
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="text" maxlength="10" name="middle_name" id="middle_name" class="form-control text_field" placeholder="Middle Name" 
								<?php
									if(isset($_GET['validation']) && 1 == $_GET['validation'])
									{
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="text" maxlength="10" name="last_name" id="last_name" class="form-control text_field" placeholder="Last Name" 
								<?php
									if(isset($_GET['validation']) && 1 == $_GET['validation'])
									{
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="text" name="email" id="email" class="form-control email" placeholder="Email ID"
								<?php
									if(isset($_GET['validation']) && 1 == $_GET['validation'])
									{
								...
								<?php 
									if(isset($_GET['validation']) && 1 == $_GET['validation'])
									{
										echo '<span class="text-danger">' . $_SESSION['error_array']['email']['msg'] . "</span>"; 
									}
								?>
							</div>
						</div>
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="password" maxlength="12" name="password" id="password" class="form-control password" placeholder="**********" 
								<?php
									if(isset($_GET['validation']) && 1 == $_GET['validation'])
									{
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<div class="radio-inline">
									<label>
										<input type="radio" name="marital" id="marital_status_1" value="Single" 
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="radio-inline">
									<label>
										<input type="radio" name="marital" id="marital_status_2" value="Married" 
											<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<div class="radio-inline">
									<label>
									<input type="radio" name="employment" id="employment_status_1" value="Employed" 
									<?php
										if(isset($_GET['validation']) && $_GET['validation'] == 1)
										{
								...
								<div class="radio-inline">
									<label>
									<input type="radio" name="employment" id="employment_status_2" value="Unemployed" 
									<?php
										if(isset($_GET['validation']) && $_GET['validation'] == 1)
										{
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<input type="text" maxlength="30" id="employer" name="employer" class="form-control" placeholder="Organization"
								<?php
									if(isset($_GET['validation']) && $_GET['validation'] == 1)
									{
						...
						<div class="row form-group">
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="r_street" name="r_street" class="form-control alpha_numeric" placeholder="Street"
										<?php
												if(isset($_GET['validation']) && $_GET['validation'] == 1)
												{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="r_city" name="r_city" class="form-control text_field" placeholder="City"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="r_zip" name="r_zip" class="form-control number_field" placeholder="751024" 
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="r_phone" name="r_phone" class="form-control number_field" placeholder="9776097760 / 06742552115" 
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="r_fax" name="r_fax" class="form-control number_field" placeholder="04442544302"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
							...
							<h4><u>Office Address :-</u></h4>
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="o_street" name="o_street" class="form-control alpha_numeric" placeholder="Street" 
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="o_city" name="o_city" class="form-control text_field" placeholder="City"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="o_zip" name="o_zip" class="form-control number_field" placeholder="751024"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="o_phone" name="o_phone" class="form-control number_field" placeholder="9776097760 / 06742552115"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
								...
								<div class="row form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<input type="text" id="o_fax" name="o_fax" class="form-control number_field" placeholder="04442544302"
										<?php
											if(isset($_GET['validation']) && $_GET['validation'] == 1)
											{
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8"> 
								<input type="file" id="pic" name="pic" value="<?php echo $row['photo'] ?>"><span>
								<?php
									if(isset($_GET['validation']) && $_GET['validation'] == 1)
									{
									...
									{
										echo '<span class="text-danger">' . $_SESSION['error_array']['photo']['msg'] . "</span>";
									}
								?></span>
							</div>
						</div>
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								...
								?>
								<textarea maxlength="200" class="form-control" id="notes" name="notes" rows="10" placeholder="Notes"><?php echo $note_value; ?></textarea>
							</div>
						</div>
						<br>
				...
				<div class="row form-group text-center">
					...
					?>
					<button class="btn btn-danger" id="reset" type="reset" name="reset" value="reset">Reset
					</button>
				</div>
			</form>
			</div>
